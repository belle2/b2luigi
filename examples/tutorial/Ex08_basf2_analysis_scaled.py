...
#
# Scope: This example demonstrates how to locally scale the analysis task from
# Ex07_basf2_analysis.py. This example is very similar to the basic luigi
# wrapper task example in Ex03_basics_b2luigi_wrappertask.py. Additionally, we
