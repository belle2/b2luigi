...
For more details, check the API documentation of :function:`b2luigi.get_setting`.
...
Here is a list of available settings already implemented in b2luigi:
    ...
    - ``htcondor_settings``: Dict
        ...
        WARNING: This setting is first loaded from the settings file and then the task specific settings are added.
    ...
    -------------------------
    To see a list of b2luigi settings mapped to gbasf2 command line options, see :class:`b2luigi.batch.processes.Gbasf2Process`.
