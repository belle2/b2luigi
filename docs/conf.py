...
latex_documents = [
    (master_doc, "b2luigi.tex", "b2luigi Documentation", "Nils Braun, Michael Eliachevitch, The Belle II Collaboration", "manual"),
]
...
texinfo_documents = [
    (master_doc, "b2luigi", "b2luigi Documentation", author, "b2luigi", "One line description of project.", "Miscellaneous"),
]
