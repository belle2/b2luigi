...
2. ... clone the ``b2luigi`` repository and move to the ``examples`` directory, e.g.
...
.. container:: toggle
   ...
   .. note::
      ...
      **Click to expand this note**
      ...
      This is the content of the note. It is hidden until the user clicks to expand the box.
